...
-- // Shorthand
local uwuLyfe = getgenv().Lyfe
local uwuMain = uwuLyfe.General
local uwuCamMain = uwuLyfe.Camlock.Main
local uwuCamFOV = uwuLyfe.Camlock.FOV
local uwuSilentMain = uwuLyfe.Silent.Main
local uwuSilentFOV = uwuLyfe.Silent.FOV
local uwuTrace = uwuLyfe.Tracer
local uwuAutoPred = uwuLyfe.AutoPrediction
...
local function SendNotification(text)
    Notification:Notify(
        {Title = "Lyfe - V1", Description = ""..text},
...
if uwuMain.Notifications then
    SendNotification("Loading Lyfe - V1")
    wait(3.5)
    SendNotification("Loaded Lyfe - V1")
end
